(() => {
    function D(e = new Date(), t = "long", r = void 0) {
        return e.toLocaleString(r, { month: t });
    }
    function L(e = new Date(), t = "numeric", r = void 0) {
        let n;
        return t === "numeric" || t === "numeric" ? (n = e.toLocaleString(r, { day: t })) : (n = e.toLocaleString(r, { weekday: t })), n;
    }
    function N(e = new Date(), t = void 0) {
        return e.toLocaleString(t, { timeStyle: "short", hour12: !0 });
    }
    function T(e) {
        e();
        let t = new Date(),
    ...
    function G(e) {
        for (let t in e.childNodes) if (e.childNodes[t].nodeType === Node.TEXT_NODE) return e.childNodes[t];
        return null;
    }
    var _ = Math.PI,
        X = 180 / _,
    ...
    async function F() {
        let e = D() + "_" + L(),
            t = await P(e);
        return t ? { id: t.pageID(), itemList: await H(t), title: t.title() } : null;
    }
    async function H(e) {
        let t = [],
            r = e.sections(),
        ...
        for (let a = 0, u = r.length; a < u; ++a) {
            let o = r[a];
            if (o.depth() === 0) n = { type: o.title().toLowerCase() };
    ...
    async function U(e) {
        ...
        for (let n = 0, a = r.length; n < a; ++n) {
            ...
            for (let o = 0, i = u.length; o < i; ++o) {
                let { year: l, text: s } = Y(u[o].text()),
                    d = { pageList: j(u[o].links(), !0), text: s, year: l };
                t.push(d);
            }
        }
        return t;
    ...
    function Y(e) {
        let t = "",
            r = "",
            n = e.indexOf("&ndash;");
        return n > 0 && ((t = e.substring(0, n - 1)), (r = e.substring(n + 8))), { year: t, text: r };
    }
    ...
    async function k() {
        ...
        async function t() {
            ...
            let i = o.itemList,
                l = I(0, i.length - 1),
                s = i[l],
                d = { monthDay: o.title, id: o.id + "." + E(s.text), year: s.year, text: s.text, relatedPageList: s.pageList };
